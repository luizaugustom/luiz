...
export class UserRepositoryImpl implements UserRepository {
  async getUser(): Promise<User> {
    return {
      ...
      projects: [],
      extraText: "I am currently a developer at Laev Software Development and I am also a member of the Rockeseat community, the largest developer community in Latin America.",
    };
  }
}
